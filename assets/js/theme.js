...
import { animate, timeline as timeline2, stagger } from "./vendor.min.js";
...
import { animate as animate2, stagger as stagger3, inView } from "./vendor.min.js";
...
import { timeline as timeline3, inView as inView2 } from "./vendor.min.js";
...
import { FocusTrap, Delegate } from "./vendor.min.js";
...
import { animate as motionAnimate, timeline as motionTimeline } from "./vendor.min.js";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "./vendor.min.js";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "./vendor.min.js";
...
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("./photoswipe.min.js"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "./vendor.min.js";
...
import { inView as inView3 } from "./vendor.min.js";
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          ...
          <path d="M18.578 32.629a.375.375 0 0 1-.578-.316V15.687c0-.297.328-.476.578-.316l12.931 8.314c.23.147.23.483 0 .63L18.578 32.63Z" fill="#23314b"/>
          <path d="M24 .5C36.979.5 47.5 11.021 47.5 24S36.979 47.5 24 47.5.5 36.979.5 24 11.021.5 24 .5Z" stroke="#23314b" stroke-opacity=".12"/>
        </svg>
      `));
    }
  }
...
import { animate as animate10, inView as inView4 } from "./vendor.min.js";
